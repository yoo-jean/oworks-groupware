            ...
            <div id="content1">
                <div id="content1_1">
                    <div class="formTitle" id="mailTitle">
                        <span style="font-size: 20px; font-weight: bold;"> 받은 메일함 &nbsp;• </span> &nbsp; <span style="font-size: 17px;">&nbsp; <b>2</b> /30 </span>
                    </div>
                    <div id="mailSub" style="border-bottom: 1px solid gray;">
                        ...
                        <div id="formSub_2">
                            <button align="right" class="btn btn-secondary btn-sm" >삭제</button>
                        </div>
                    </div>
                    <div id="mailList" > 
            ...
            <div id="content2">
                <div id="content2_detail" >
                    ...
                    <div id="mailBtn" class="formTitle">
                        ...
                        <div id="mailAct">
                            <i id="replyBtn" title="답장" class="fa fa-mail-reply imgBtn" style="font-size:24px"></i> &nbsp; &nbsp;
                            <i id="trashBtn" title="휴지통" class="fa fa-trash-o imgBtn" style="font-size:27px; margin-top: 10px; margin-left: -3px;"></i>
                        </div>
                    </div>
                    ...
                    <div id="mailDetail">
                        ...
                        <div class="viewSendEmp">
                            <div class="viewSendEmp1"> 보낸 사원</div>
                            <div class="viewSendEmp2"> 김가나(10015)</div>
