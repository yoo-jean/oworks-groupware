    ...
    <div class="approvalouter" style="position: absolute; left: 400px; top: 50px; width: 1000px;">
        <div class="approvalinner">
            ...
            <div class="searchfield">
				...
				<!-- 검색영역 -->
                <form id="searchForm" action="completeSearch.ap" align="center">
                    ...
                    <tbody>
                    	<c:choose>
                    		<c:when test = "${fn:length(finishList) eq 0 }" >
                    			<tr>
                    				<td colspan = "7" align="center"> 완료 문서가 없습니다.</td>
                    			</tr>
                    		</c:when>
                ...
                <div id="pagingArea">
	                <ul class="pagination">
	                	<c:choose>
	                    	...
	                    	<c:otherwise>
	                    		<li class="page-item"><a class="page-link" href="complete.ap?currentPage=${pi.currentPage-1 }&empNo=${loginEmp.empNo}&empName=${loginEmp.empName}&status=완료"><</a></li>
	                    	</c:otherwise>
	                    </c:choose>
	                    
	                    <c:forEach var = "p" begin = "${pi.startPage }" end = "${pi.endPage }">
	                    	<li class="page-item"><a class="page-link" href="complete.ap?currentPage=${p }&empNo=${loginEmp.empNo}&empName=${loginEmp.empName}&status=완료">${p }</a></li>
	                    </c:forEach>
