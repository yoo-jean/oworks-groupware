        ...
        <div class="approvalinner">
            ...
            <div class="searchfield">
                ...
                <form id="searchForm" action="deleteListSearch.ap" align="center">
                	...
                	<input type="hidden" name="deleteStatus" value = "Y">
                ...
                <div id="pagingArea">
	                <ul class="pagination">
	                	<c:choose>
	                    	...
	                    	<c:otherwise>
	                    		<li class="page-item"><a class="page-link" href="deleteApprovalList.ap?currentPage=${pi.currentPage-1 }&empNo=${loginEmp.empNo}&empName=${loginEmp.empName}&status=진행"><</a></li>
	                    	</c:otherwise>
	                    </c:choose>
	                    
	                    <c:forEach var = "p" begin = "${pi.startPage }" end = "${pi.endPage }">
	                    	<li class="page-item"><a class="page-link" href="deleteApprovalList.ap?currentPage=${p }&empNo=${loginEmp.empNo}&empName=${loginEmp.empName}&status=진행">${p }</a></li>
	                    </c:forEach>
