                ...
                <div id="pagingArea">
	                <ul class="pagination">
	                	<c:choose>
	                    	...
	                    	<c:otherwise>
	                    		<li class="page-item"><a class="page-link" href="wait.ap?currentPage=${pi.currentPage-1 }&empNo=${loginEmp.empNo}&empName=${loginEmp.empName}&status=대기"><</a></li>
	                    	</c:otherwise>
	                    </c:choose>
	                    
	                    <c:forEach var = "p" begin = "${pi.startPage }" end = "${pi.endPage }">
	                    	<li class="page-item"><a class="page-link" href="wait.ap?currentPage=${p }&empNo=${loginEmp.empNo}&empName=${loginEmp.empName}&status=대기">${p }</a></li>
	                    </c:forEach>
