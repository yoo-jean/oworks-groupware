...
<body>
    ...
    <div class="outer">
        ...
        <div class="innerOuter">
            <h2 id="text1">자유게시판 수정</h2><hr>

            <form id="enrollForm" method="post" action="" enctype="">
                <table align="center">
                    <tr>
                        <th><label for="title">제목</label></th>
                        <td><input type="text" id="fbTitle" class="form-control" name="fbTitle" required value="수정할제목"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th colspan="2"><textarea class="form-control" required name="fbContent" id="fbContent" rows="10" style="resize:none;">수정할내용</textarea></th>
                    </tr>
                </table>
                <br>
