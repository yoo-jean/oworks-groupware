...
<body>
    ...
    <div class="main">
		...
		<form id="updateForm" method="post" action="update.db" enctype="multipart/form-data">
	        ...
	        <table align="center" style="border:1px solid rgb(227, 227, 227);" class="table">
	            <tr>
	                <th width="13%">제목</th>
	                <td height="30px" colspan="5"><input type="text" class="form-control" name="boardTitle" value="${ b.boardTitle }" placeholder="제목을 입력하세요." required ></td>
	            </tr>
	            <tr>
	                <th>첨부파일</th>
	                <td height="30px" colspan="5">
						...
						<c:if test="${ !empty b.originName }">
	                		<br> 현재 업로드 된 파일 : <a href="${ b.changeName }" download="${ b.originName }">${ b.originName }</a>
	            ...
	            <tr>
	                <th>내용</th>
	                <td colspan="5" >
	                    <textarea id="content" rows="15" name="boardContent" class="form-control" style="resize:none;" required>${ b.boardContent }</textarea>
	                </td>
	            </tr>
	        </table>
