...
<body>
    ...
    <div class="outer">
        <span id="text1">회의실 예약하기</span><hr>

        <!-- enctype="multipart/form-data" !!-->
        <form id="meetingEnrollForm" action="버튼클릭시 이동할페이지 연동" method="post" enctype="multipart/form-data">
            <table id="meeting" border="1" style="text-align: center;">
                <tr style="border-right: white; height: 60px;">
                    ...
                    <td style="width: 650px;">&emsp;&emsp;&emsp;<input type="text" name="mrTitle" required placeholder="&nbsp;회의제목을 입력해주세요." style="width: 550px;" maxlength="30"></td>
                </tr>
                <!-- 로그인하고 회의실예약한 회원의 이름 가져오기 -->
                <tr style="border-right: white; height: 60px;">
                ...
                <tr style="border-right: white; height: 75px;">
                    ...
                    <td>
                        <input type="number" name="mrPerson" max="5" min="1" placeholder="1" style="width: 100px;" required><br>
                        <span id="text3">(최소 1명, 최대 5명까지 선택하실 수 있습니다.)</span>
                    </td>
                </tr>
                <tr style="border-right: white; height: 60px;">
                    <th style="padding-left: 60px;">회의내용</th>
                    <td>&emsp;&emsp;&emsp;<input type="text" name="mrContent" style="width: 550px;" maxlength="30" placeholder="&nbsp;회의내용을 입력해주세요."></td>
                </tr>
            </table>
            <br>
            <div id="btn" align="center">
                <a class="btn btn-primary btn-sm" href=""><b>예약</b></a>&nbsp;
